...
public class MainClass {
  ...
  public static void method1() {
    ...
    try {
      ...
      // 쿼리문
      String sql = "INSERT INTO SAMPLE_T(SAMPLE_NO, SAMPLE_CONTENT, SAMPLE_EDITOR, SAMPLE_DT) VALUES(SAMPLE_SEQ.NEXTVAL, '콘텐츠','에디터',CURRENT_DATE)";  // 문자열 안에 세미콜론 X
  ...
  public static void method3() {
    ...
    try {
      ...
      // 입력값을 쿼리문에 전달
      ps.setInt(1, sampleNo);  // 쿼리문의 1번째 물음표에 sample_No 전달
  ...
  public static void method5() {
    ...
    try {
      ...
      Scanner sc = new Scanner(System.in);
      System.out.println("콘텐츠 입력 >>>");
      String samcon = sc.next();
      System.out.println("에디터 입력 >>>");
      String samedi = sc.next();
      
      
      
      
     ps.setString(1, samcon);
      ps.setString(2, samedi);
  ...
  public static void method6() {
   ...
   try {
    ...
    String sql = "UPDATE SAMPLE_T SET SAMPLE_CONTENT =? WHERE SAMPLE_NO =?";
