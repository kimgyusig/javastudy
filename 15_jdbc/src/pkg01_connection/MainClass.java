...
public class MainClass {
   ...
   * 2. 오라클에서 만들어서 배포한다.
   * 3. 18c XE 버전의경우 C:\app\사용자\product\18.0.0\dbhomeXE\jdbc\lib\ojdbc8.jar 파일을 프로젝트의 build path 에 등록해야 한다.
   */
   ...
   *  3. 프로퍼티 추가 방법
   *     1. [Run] - [Run configurations] - [Arguments] - [VM arguments]   실행될 때 값이   넘어간다.  코드로 남지 않는다.
   *     2. 프로퍼티 앞에 prefix(고정) 값으로 -D 를 사용한다.  
