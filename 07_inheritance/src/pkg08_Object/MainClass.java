...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(book.toString() );   //  "객체명@참조값" 을 반환
     ...
     student1.addBook(new Book("979-11-6224-187-6", "혼자 공부하는 자"));
     student1.addBook(new Book("979-11-6224-187-7", "혼자 공부하는 자바자"));
     student1.addBook(new Book("979-11-6224-187-8", "혼자 공부하는 자바바"));
     student1.addBook(new Book("979-11-6224-187-9", "혼자 공부하는 자바2"));
