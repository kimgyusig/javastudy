...
public class MainClass {
    ...
    try {
     ...
     // 읽은 글자수
      ...
      while(true) {
        ...
        builder.append(cbuf, 0, readChar);  // cbuf[0]부터 readChar만큼 builder 에 추가
      }
      
      // 확인
      System.out.println(builder.toString());  // builder 사용했으면 마직막은 toString
  ...
  public static void method3() {
    ...
    try {
      ...
      //BufferedReader 생성
      // 바이트 입력 스트림(FileInputStream) -> 문자입력 스트림(InputStreamReader) -> 버퍼 입력 스트림(BufferedReader)
