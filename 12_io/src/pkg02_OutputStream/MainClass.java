...
public class MainClass {
  ...
  public static void method1() {
    ...
    try {
      ...
      // 파일 출력 스트림 닫기(종료)
      //out.close(); 스트림은 finally 이 아니라 여기서 마무리가능
      ...
      try {
     // 파일 출력 스트림 닫기(종료)
        if(out != null)  //  if 코드 작성 안할시 nullpointException 이발생한다
          out.close();
      } catch (Exception e2) {
        e2.printStackTrace();
      }
  ...
  public static void practice1() {
    ...
    File file = new File(dir, "애국가 1.dat");
  ...
  public static void practice2() {
    // BufferedOutputStream 으로 애국가 2절 파일로 보내기 : 시간재기
    ...
    try {
      ...
      String str = "남산 위에 저 소나무 철갑을 두른듯 \n바람서리 불변함은 우리기상일세";
