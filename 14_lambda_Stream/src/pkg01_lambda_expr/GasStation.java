 ...
 *               return 문자열
 *             };
 *    2) A a = () -> 문자열        // 본문 내용이 return 만 있는경우 중괄호 {}와 return 키워드를 생략할 수 있다.         
 * 3. 파라미터 O, 반환 X
 ...
 *                return 문자열
 *              };
 *    2) A a = (name) -> 문자열     // 본문 내용이 return 만 있는경우 중괄호 {}와 return 키워드를 생략할 수 있다.
 */
...
public class GasStation {
  ...
  // method
  public void sellOil(String model, int oil) {  //임시 객체 sellOil 끝나면 소멸된다.
   ...
   /* Car car = new Car() {
      ...
      public void addOil() {
        ...
        System.out.println(model + "차량" + "L 주유 완료");
      }
    }; */
