...
public class CompanyHandler {
  ...
  public CompanyHandler(Company company) {
    ...
    this.company =company;  // company 정보를 받아서 저장
  }
  
  // method
  
  // 사원 정보 입력 ->  company.hire(getEmployee())  -> hire -> List<Employee> employees
  private Employee getEmployee() throws InputMismatchException, RuntimeException {  // 호출한곳으로던진다.company.hire(getEmployee())  예외 발생하면 null 값을넘긴다
    ...
    default:
    throw new RuntimeException("잘못된 사원타입 입니다.");
    }
