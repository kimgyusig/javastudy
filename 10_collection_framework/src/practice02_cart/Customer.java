...
public class Customer {
  ...
  // 물건 바꾸기
  public void chagneCart(int idx, Product product) throws RuntimeException {
    cart.chagneProduct(idx, product);
  }
  ...
  public String buy() throws RuntimeException {
    ...
    for(int i =0, count = cart.getProducts().size(); i < count; i++ ) {    //메소드는물어보고가져오는것 계속 반복되면좋지않다 한번뿐인 초기값에 변수 선언해서 사용
